...
<style include="shared-styles">
      ...
      <fieldset>
        ...
        <div class="dropdowns">
          ...
          <select name="sex" id="sex" on-change="onChangeSelect">
        ...
        <div class="dropdowns">
          ...
          <select name="age" id="age" on-change="onChangeSelect">
        ...
        <div class="dropdowns">
          ...
          <select name="age-mother-birth" id="age-mother-birth" on-change="onChangeSelect">
        ...
        <div class="dropdowns">
          ...
          <select name="age-father-birth" id="age-father-birth" on-change="onChangeSelect">
        ...
        <div class="dropdowns">
          ...
          <select name="age-difference" id="age-difference" on-change="onChangeSelect">
        ...
        <div class="dropdowns">
          ...
          <select name="origin" id="origin" on-change="onChangeSelect">
        ...
        <div class="dropdowns">
          ...
          <select name="help" id="help" on-change="onChangeSelect">
